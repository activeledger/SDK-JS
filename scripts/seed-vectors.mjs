...
const HEADER = [
  ...
  "invisible. Varnir's chain-client ships its own, live since Activeledger",
  "4.7.0 on 2026-09-14, and it differs for EVERY key type:",
  "",
  "                 this file                        varnir",
  "  ml-dsa-65      HKDF-SHA512, salt \"\",           HKDF-SHA256, salt undefined,",
  "                 activeledger-seed-v1:<type>     varnir/pq-keygen/v1:<type>",
  "  falcon-512     as above                        as above",
  "  secp256k1      HMAC-SHA512(\"Bitcoin seed\", S)  BIP-32 child at",
  "                 - the master key, no child      m/44'/1'/0'/0/0",
  "",
  ...
  "that simply is not the one the ledger knows.",
  "",
  "Measured, not inferred. The phrase is NAMED rather than described, because",
  "a published value whose input is not stated cannot be reproduced - and the",
  "reader who tries will pin it against a different phrase and lose an",
  "afternoon to a mismatch that is not a bug. It is the standard BIP-39 test",
  "mnemonic:",
  "",
  "  legal winner thank year wave sausage worth useful legal winner thank",
  "  yellow",
  "",
  "  ml-dsa-65   this file  dO3FEUip...      varnir  fHVRrFv1...",
  "  secp256k1   this file  0x02c4c9a1...    varnir  0x02080faa...",
  "",
  "  (public keys, base64 for ml-dsa-65 and compressed hex for secp256k1)",
  "",
  "DO NOT \"UNIFY\" THE TWO. They differ by a hash and an info string, which",
  "reads like an accident and is not one: identities exist on both sides whose",
  "only backup is a phrase, and changing either derivation orphans them.",
  "",
  ...
  "Verified: deriving varnir's seed and passing it to this SDK's fromSeed",
  "reproduces varnir's key exactly. That layering is why the derivation here is",
