...
const HEADER = [
  ...
  "that simply is not the one the ledger knows. Measured, not inferred: one",
  "phrase through both produces ml-dsa-65 public keys fHVRrFv1... and",
  "dO3FEUip..., and secp256k1 keys 0x02080faa... and 0x02c4c9a1...",
  "",
